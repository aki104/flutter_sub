...
mixin _$UserState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int userId) authenticated,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(int userId)? authenticated,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$UserStateAuthenticated implements UserStateAuthenticated {
  const _$UserStateAuthenticated({required this.userId});
  ...
  @override
  String toString() {
    return 'UserState.authenticated(userId: $userId)';
  }
...
abstract class UserStateAuthenticated implements UserState {
  const factory UserStateAuthenticated({required final int userId}) =
